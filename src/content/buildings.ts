...
//
//   Sett 3  (cap 250)  → L8     Sett 7  (cap 4k)   → L28
//   Sett 4  (cap 500)  → L12    Sett 8  (cap 10k)  → L35
//   Sett 5  (cap 1k)   → L16    Sett 9  (cap 100k) → L50
//   Sett 6  (cap 2k)   → L21
const FARM_COSTS = [
...
export const BUILDINGS: Record<BuildingId, BuildingDef> = {
  ...
  blacksmith: {
    ...
    levels: [
      ...
      { cost: { stone: 400, iron: 1 }, summary: 'Unlocks sword crafting.', requiresLevel: 5 },
      { cost: { stone: 800, steel: 1 }, summary: 'Unlocks staff crafting.', requiresLevel: 6 },
      { cost: { stone: 1600, mithril: 1 }, summary: 'Unlocks gladius crafting.', requiresLevel: 7 },
      { cost: { stone: 3200, adamantium: 1 }, summary: 'Unlocks claymore crafting.', requiresLevel: 8 },
    ],
  },
  hunterscabin: {
    name: "Hunter's Cabin",
  ...
  deepmine: {
    ...
    levels: [
      ...
      { cost: { wood: 900 }, summary: 'Unlocks steel.', requiresLevel: 5 },
      { cost: { wood: 1800 }, summary: 'Unlocks mithril.', requiresLevel: 6 },
      { cost: { wood: 3600 }, summary: 'Unlocks adamantium.', requiresLevel: 7 },
      { cost: { wood: 72000 }, summary: 'Unlocks obsidion.', requiresLevel: 9 },
    ],
  },
  barracks: {
    name: 'Barracks',
    ...
    levels: [
      ...
      { cost: { stone: 600, sword: 1 }, summary: 'Unlocks warriors (swords + fur).', requiresLevel: 5 },
      { cost: { stone: 1200, staff: 1 }, summary: 'Unlocks mages (staves + magic orbs).', requiresLevel: 6 },
      { cost: { stone: 2400, gladius: 1 }, summary: 'Unlocks centurions.', requiresLevel: 7 },
      { cost: { stone: 4800, claymore: 1 }, summary: 'Unlocks war generals.', requiresLevel: 8 },
    ],
  },
  wizardtower: {
    name: 'Wizard Tower',
  ...
  castle: {
    ...
    levels: [
      ...
      { cost: { stone: 800, warrior: 5 }, summary: 'Outpost — unlocks magic orbs. Defense cap 20.', requiresLevel: 5, sets: { defenseMax: 20 } },
      { cost: { stone: 1600, mage: 1 }, summary: 'Stronghold — unlocks soul gems. Defense cap 30.', requiresLevel: 6, sets: { defenseMax: 30 } },
      { cost: { stone: 3200, centurion: 1 }, summary: 'Fortress — unlocks star metal. Defense cap 50.', requiresLevel: 7, sets: { defenseMax: 50 } },
      { cost: { stone: 6400, wargeneral: 1 }, summary: 'Castle — unlocks holy water. Defense cap 75.', requiresLevel: 8, sets: { defenseMax: 75 } },
    ],
  },
  cloudshaman: {
    name: 'Cloud Shaman',
